...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Iyge5zbs.mjs");
...
const manifest = {
  "1ac20e83585a55e943670fa4670b07889b610801a7a21f28dc367c19f92e50fd": {
    ...
    importer: () => import("./contact.functions-BzOG-fHa.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DonqoYKP.mjs"),
    import("./start-DaejP7-G.mjs"),
